import { registerUpdateTasksBatchTool } from '../../../../src/mcp/tools/tasks/update-batch';
import { updateTasksBatch } from '../../../../src/core/actions/task';
...
jest.mock('../../../../src/core/actions/task', () => ({
  updateTasksBatch: jest.fn()
}));

// Mock the path and file utilities
jest.mock('../../../../src/core/utils/files', () => ({
  pcwd: () => '/test/cwd'
}));
